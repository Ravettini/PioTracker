...
export default function CargaPage() {
  ...
  // Verificar que el sistema está funcionando (si puede cargar ministerios, todo funciona)
  const checkGoogleSheetsConnection = useCallback(async () => {
    // Simplemente asumimos que si el usuario está autenticado, Google Sheets funciona
    // Ya que el dashboard y otros componentes cargan datos correctamente
    console.log('✅ Sistema verificado - Google Sheets operativo');
